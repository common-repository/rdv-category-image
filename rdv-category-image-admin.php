...
if ( ! class_exists( 'RDV_CT_TAX_META' ) ) {
    ...
    class RDV_CT_TAX_META {
		...
		public $rdv_category_image_version = '1.0.9';
		
        public function __construct() {
            // This action load all custom categories in function init()
        ...
        */        
        ...
        /*
        * Initialize the class and start calling hooks and filters
        * @since 1.0.0
        */
        public function init_rdv_category_image() {
            add_action( 'admin_enqueue_scripts', array( $this, 'rdv_load_media' ) );
        ...
        * @since 1.0.0
        */
        public function rdv_load_media() {
            wp_enqueue_media();
        }
